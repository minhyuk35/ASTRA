    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: "#050508" }}>
      ...
      >
        ...
        <p className="text-white/30 text-xs font-light mb-12" style={{ letterSpacing: "0.12em" }}>
          No account?{" "}
          <Link href="/auth/signup" className="text-white/55 hover:text-white/80 transition-colors underline underline-offset-2">
            Create one
          </Link>
        </p>
        ...
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="rgba(255,255,255,0.35)" />
